 ...
 */
public class ObjectRecognitionTask extends AsyncTask<Object, Void, String> {
    ...
    private static final String LOG_TAG = ObjectRecognitionTask.class.getSimpleName();
    public AsyncResponse delegate = null;


    public ObjectRecognitionTask(Bitmap bitmap, Context context, Activity activity, ProgressDialog progressDialog, AsyncResponse delegate) {
